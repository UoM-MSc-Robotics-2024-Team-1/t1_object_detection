...
class ToolHelper():
    ...
    def save_xml(self, file_name, save_folder, img_info, height, width, channel, bboxs_info):
        '''
        :param file_name:文件名
        :param save_folder:#保存的xml文件的结果__
        :param height:图片的信息
        :param width:图片的宽度
        :param channel:通道
        :return:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source_img_path', type=str, default=r'C:\Users\25166\Desktop\dataset\diamond_img')
    parser.add_argument('--source_xml_path', type=str, default=r'C:\Users\25166\Desktop\dataset\diamond_xml')
    parser.add_argument('--save_img_path', type=str, default=r'C:\Users\25166\Desktop\dataset\diamond_img')
    parser.add_argument('--save_xml_path', type=str, default=r'C:\Users\25166\Desktop\dataset\diamond_xml')
